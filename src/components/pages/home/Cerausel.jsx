      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative h-full w-full">
            ...
            {/* Dark Overlay */}
            <div className="absolute inset-0 bg-black/80 z-10" /> {/* Increased opacity to 60% */}
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
              <div className="space-y-6 text-white max-w-4xl">
                ...
                <button className="mt-8 px-8 py-3 bg-cyan-500 hover:bg-cyan-600 rounded-full text-lg font-semibold transition-colors duration-300 animate-fade-in-up delay-300">
                  Learn More
                </button>
              </div>
            </div>
